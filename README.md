...
~~~sh
# getting the code
git clone git@github.com:nko4/faraday-cage-match.git && cd ./faraday-cage-match/

# developing
npm install
npm start

# deploying (to http://faraday-cage-match.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@faraday-cage-match.2013.nodeknockout.com
ssh root@faraday-cage-match.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@faraday-cage-match.2013.nodeknockout.com
ssh -i ./id_deploy root@faraday-cage-match.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/faraday-cage-match" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
